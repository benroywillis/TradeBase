...
inline void PrintResults( const std::unique_ptr<BTBrain>& brain )
{
    ...
    std::cout << "Ending cash was " << brain->Account->getCash() << std::endl;
    std::cout << "Ending margin loan was " << brain->Account->getMarginLoan() << std::endl;
    std::cout << "Total commission was " << brain->Broker->getTotalCommission() << std::endl;
    std::cout << "PnL was " << brain->Account->getPnL() << std::endl;
    std::cout << "UPnL was " << brain->Account->getUPnL() << std::endl;
    std::cout << "Total account change was " << brain->Account->getUPnL()+brain->Account->getPnL() << std::endl;
    std::cout << "Ending positions are " << std::endl;
    for( auto& index : brain->Account->positions )
    {
